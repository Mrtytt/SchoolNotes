...
- Bir sinyalin bir işlem tarafından algılanabilmesi ve işlenebilmesi için sinyalin blokelenmemiş olması (try-catch) ve çalışması kesilebilir (interruptable) surumda olması lazım.
...
- OpenMP:
	...
	- Shared memory yak8laşımı kullanır.
